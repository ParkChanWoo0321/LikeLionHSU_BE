...
백엔드 수업 자료는 직접 Notion으로 제작하여 정리하였고, 각 주차별 이론 설명과 실습 가이드를 함께 구성했습니다.

| 구분    | 링크                                                                                           |
| ----- | -------------------------------------------------------------------------------------------- |
| 수업 자료 | [Notion 바로가기](https://app.notion.com/p/14-32c903023d6680eeb55ef245e2c594ff?source=copy_link) |
